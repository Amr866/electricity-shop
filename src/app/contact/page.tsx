      ...
      <div className="max-w-7xl mx-auto px-4 space-y-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <div className="inline-flex items-center gap-1.5 bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-bold px-3 py-1 rounded-full border border-amber-300 dark:border-amber-700">
            ...
            <span>شعبه مرکزی و کارگاه فنی نجف‌آباد</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 text-slate-900 dark:text-white">
              <h2 className="font-extrabold text-sm border-b border-slate-100 dark:border-slate-800 pb-3 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-amber-500" />
                <span>اطلاعات تماس و نشانی دقیق فروشگاه</span>
              </h2>

              <div className="space-y-3.5 text-xs text-slate-600 dark:text-slate-300">
                <div className="bg-slate-50 dark:bg-slate-800/80 p-3.5 rounded-2xl border border-slate-100 dark:border-slate-700 space-y-1">
                  <span className="text-slate-400 dark:text-slate-400 font-bold block">نشانی شعبه نجف‌آباد:</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800/80 p-3 rounded-2xl border border-slate-100 dark:border-slate-700">
                    <span className="text-slate-400 font-bold block mb-1">واحد تعمیرات:</span>
                    <a href="tel:09162665884" className="font-bold text-emerald-600 dark:text-emerald-400 text-sm persian-numbers hover:text-emerald-500">
                      ۰۹۱۶-۲۶۶-۵۸۸۴
                    </a>
                  </div>
                </div>

                <div className="bg-slate-50 dark:bg-slate-800/80 p-3.5 rounded-2xl border border-slate-100 dark:border-slate-700 flex items-center gap-2">
                  <Clock className="w-4 h-4 text-blue-500 shrink-0" />
                  <div>
                    <strong className="text-slate-900 dark:text-white block">ساعات کاری فروشگاه:</strong>
              ...
              <div className="pt-2 flex flex-col gap-2">
                <a
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs py-3 rounded-xl text-center flex items-center justify-center gap-2 shadow-md transition-colors active:scale-95"
                >
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-950 text-white rounded-3xl p-6 border border-slate-800 space-y-2">
              ...
              <p className="text-xs leading-relaxed text-slate-300">
                پیمانکاران و مشتریان عزیز در نجف‌آباد و اصفهان می‌توانند پس از ثبت سفارش، مرسوله خود را در همان روز توسط اسنپ‌باکس یا پیک ویژه تحویل بگیرند.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-sm space-y-5 text-slate-900 dark:text-white">
              <h2 className="font-extrabold text-base border-b border-slate-100 dark:border-slate-800 pb-3 flex items-center gap-2">
                <Send className="w-4 h-4 text-amber-500" />
                <span>ارسال پیام مستقیم به کارشناسان {brand.nameFa}</span>
              </h2>

              {submitted ? (
                <div className="bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-6 text-center space-y-2 text-emerald-900 dark:text-emerald-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs sm:text-sm rounded-xl transition-all shadow-md shadow-amber-500/20 flex items-center justify-center gap-2 active:scale-95"
                  >
