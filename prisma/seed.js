...
async function main() {
  ...
  const settings = [
    ...
    { key: 'store_address', value: 'اصفهان، نجف‌آباد، ۱۵ خرداد مرکزی، نبش بن‌بست نرگس (فروشگاه شیاسی)' },
    { key: 'store_maps_url', value: 'https://maps.app.goo.gl/cXf7MouMBVSPUKDo9' },
    { key: 'store_neshan_url', value: 'https://neshan.org/maps/places/vbZnI32x4clP' },
    { key: 'store_phone', value: '03142626116' },
    { key: 'store_phone_alt', value: '03142626107' },
    { key: 'store_mobile', value: '09136260072' },
    { key: 'store_repair_phone', value: '09136260072' },
    { key: 'store_whatsapp', value: '989136260072' },
    { key: 'store_working_hours', value: 'شنبه تا چهارشنبه: ۸:۳۰ الی ۱۳:۰۰ و ۱۶:۳۰ الی ۲۱:۰۰ | پنج‌شنبه‌ها: ۸:۳۰ الی ۱۳:۰۰ (شیفت عصر تعطیل) | جمعه‌ها: تعطیل' },
