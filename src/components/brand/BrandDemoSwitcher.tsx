...
export function BrandDemoSwitcher() {
  ...
  const options: { key: BrandKey; title: string; subtitle: string }[] = [
    {
      key: "shiasi",
      title: "دمو ۱: فروشگاه تخصصی شیاسی",
      subtitle: "طراحی مدرن قطعات و تجهیزات",
    },
    {
      key: "shiasi_appliances",
      title: "دمو ۲: لوازم برقی و خانگی شیاسی",
      subtitle: "پنکه، کولر آبی، بخاری و آنتن",
    },
    {
      key: "shiasi_workshop",
      title: "دمو ۳: کارگاه فنی و خدمات تعمیرات",
      subtitle: "تعمیرات تخصصی در نجف‌آباد",
    },
  ];
    ...
    <div className="bg-slate-950 text-white border-b border-amber-500/30 px-3 py-2 text-xs no-print">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-amber-400 font-bold">
          ...
          <span>انتخاب نمای هویت فروشگاه شیاسی:</span>
        </div>
