...
export default function OrderLookupPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "تا زمانی که وضعیت سفارش در حالت «ثبت اولیه» یا «در حال آماده‌سازی» باشد، می‌توانید با تماس مستقیم با واحد فروش (۰۳۱-۴۲۶۲۴۵۶۷) آدرس را تغییر داده یا سفارش را ویرایش نمایید.",
    },
  ];
