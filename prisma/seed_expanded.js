...
async function main() {
  ...
  const appliancesTemplates = [
    ...
    { name: 'پمپ آب کولر الکتروژن مدل البرز ضدآب و کم‌مصرف', brand: 'الکتروژن (Electrogen)', price: 420000, img: '/images/products/adonyig-machine-3098797_1920.jpg' },
    { name: 'پمپ آب کولر موتوژن تبریز پرقدرت با عایق‌بندی کلاس B', brand: 'موتوژن تبریز (Motogen)', price: 540000, img: '/images/products/is463940-generator-5476642_1920.jpg' },
    ...
    { name: 'ترموستات دیجیتال کنترل دمای کولر و فن شیاسی مدل هوشمند', brand: 'شیوا امواج (Shiva Amvaj)', price: 480000, img: '/images/products/close-up-circuit-reparing-tool.jpg' },
    { name: 'کلید کولر آبی هوشمند لمسی مجهز به ریموت کنترل رادیویی', brand: 'پارت الکتریک (Part Electric)', price: 620000, img: '/images/products/close-up-circuit-reparing-tool.jpg' },
    { name: 'یاتاقان بلبرینگی کولر آبی سایز ۳/۴ صنعتی ضدزنگ', brand: 'موتوژن تبریز (Motogen)', price: 125000, img: '/images/products/richard_ssmid-equipment-3111880_1920.jpg' },
    { name: 'تسمه کولر آبی سایز A68 استاندارد کره‌ای ضدسایش', brand: 'دانگیل (Dongil)', price: 95000, img: '/images/products/republica-wire-732209_1920.jpg' },
