...
- **Product**: Unique identifier, title, URL slug, SKU, manufacturer part number (MPN), category reference, retail price, promotional price, discount percentage, available stock quantity, minimum order quantity (MOQ), brand name, warranty terms, country of origin, delivery badges, and creation/update timestamps.
