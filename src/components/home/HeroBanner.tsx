...
const SHOWCASE_CATEGORIES = [
  {
    ...
    // 1. Amber / Gold (Matches cooling-heating category in /categories)
    hoverBorder: "hover:border-amber-500 dark:hover:border-amber-400",
    hoverShadow: "hover:shadow-amber-500/20 hover:shadow-2xl",
    glowBg: "group-hover:from-amber-500/20 group-hover:via-amber-500/5 group-hover:to-transparent",
  ...
  },
  {
    ...
    // 2. Electric Sky / Blue (Matches industrial cooling & electric motor in /categories)
    hoverBorder: "hover:border-blue-500 dark:hover:border-blue-400",
    hoverShadow: "hover:shadow-blue-500/20 hover:shadow-2xl",
    glowBg: "group-hover:from-blue-500/20 group-hover:via-blue-500/5 group-hover:to-transparent",
    badgeStyle: "bg-blue-50 dark:bg-blue-950/80 text-blue-800 dark:text-blue-300 border-blue-200/80 dark:border-blue-800",
  ...
  },
  {
    ...
    // 3. Emerald Green (Matches lighting-solar category in /categories)
    ...
    glowBg: "group-hover:from-emerald-500/20 group-hover:via-emerald-500/5 group-hover:to-transparent",
    badgeStyle: "bg-emerald-50 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 border-emerald-200/80 dark:border-emerald-800",
  ...
  },
  {
    ...
    // 4. Electric Blue / Wiring (Matches wiring-cables category in /categories)
    hoverBorder: "hover:border-blue-500 dark:hover:border-blue-400",
    hoverShadow: "hover:shadow-blue-500/20 hover:shadow-2xl",
    glowBg: "group-hover:from-blue-500/20 group-hover:via-blue-500/5 group-hover:to-transparent",
    badgeStyle: "bg-blue-50 dark:bg-blue-950/80 text-blue-800 dark:text-blue-300 border-blue-200/80 dark:border-blue-800",
