          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="inline-flex items-center gap-2 bg-amber-500/20 text-amber-300 text-xs font-extrabold px-3 py-1 rounded-full border border-amber-500/30">
                ...
                <span>فروشگاه مرکزی در قلب بازار برق اصفهان</span>
              </div>

              <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight text-white">
                خدمات اختصاصی ویژه <br />
                <span className="text-amber-400">همشهریان و سازندگان محترم اصفهان</span>
              </h2>

              <p className="text-slate-300 text-xs sm:text-sm leading-relaxed text-justify">
                فروشگاه الکتریک نقش جهان واقع در خیابان فردوسی اصفهان، علاوه بر امکان خرید آنلاین با ارسال سریع، امکان خرید حضوری، بررسی نمونه کالاها و دریافت فاکتور رسمی نظام مهندسی را برای پیمانکاران، برق‌کاران و همشهریان گرامی فراهم نموده است.
              </p>

              {/* Grid of Isfahan Specific Advantages */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
                ...
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-xl border border-slate-700">
                  ...
                  <div>
                    <strong className="text-xs font-bold text-white block">تحویل حضوری رایگان</strong>
                    <span className="text-[11px] text-slate-400">دریافت آنی سفارش در شعبه خیابان فردوسی</span>
                  </div>
                </div>
            ...
            {/* Right Col: Location & Quick Contact Card */}
            <div className="lg:col-span-5">
              <div className="bg-slate-800/90 rounded-2xl p-6 border border-slate-700 shadow-xl space-y-4">
                <h3 className="font-extrabold text-base text-amber-400 flex items-center gap-2">
                  ...
                  <span>اطلاعات شعبه و ساعات مراجعه</span>
                </h3>

                <div className="space-y-3 text-xs text-slate-300">
                  <div className="bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                    <span className="text-slate-400 block text-[10px] mb-1">آدرس فروشگاه:</span>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      <span className="text-slate-400 block text-[10px] mb-1">تلفن ثابت:</span>
                      <a href="tel:03132204567" className="font-bold text-amber-400 persian-numbers text-sm">
                        ۰۳۱-۳۲۲۰۴۵۶۷
                      </a>
                    </div>
                    <div className="bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      <span className="text-slate-400 block text-[10px] mb-1">همراه و واتساپ:</span>
                      <a href="tel:09131112233" className="font-bold text-emerald-400 persian-numbers text-sm">
                        ۰۹۱۳-۱۱۱-۲۲۳۳
                      </a>
                    </div>
                  </div>
                ...
                <div className="pt-2 flex gap-2">
                  <Link
                    href="/contact"
                    className="flex-1 bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs py-2.5 rounded-xl text-center transition-colors"
                  >
                    مسیریابی روی نقشه
                  </Link>
                  <a
