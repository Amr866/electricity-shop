    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 py-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="font-extrabold text-lg text-white">الکتریک نقش جهان</span>
                <span className="mr-2 text-xs bg-amber-400/20 text-amber-300 font-bold px-2 py-0.5 rounded">شعبه اصفهان</span>
              </div>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed text-justify">
              فروشگاه کالای برق و الکترونیک نقش جهان، مرجع تخصصی توزیع و فروش عمده و خرد انواع سیم و کابل ساختمانی تمام مس، پنل‌ها و پروژکتورهای ال‌ای‌دی، تجهیزات تابلویی و اتوماسیون صنعتی، و ماژول‌ها و بردهای الکترونیکی در استان اصفهان می‌باشد.
            </p>

            <div className="space-y-2.5 text-xs text-slate-300 pt-2">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                <span>اصفهان، خیابان فردوسی، نرسیده به چهارراه فلسطین، پلاک ۱۲۸</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>تلفن فروشگاه: <strong className="text-white persian-numbers">۰۳۱-۳۲۲۰۴۵۶۷</strong></span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li>
                <Link href="/order-tracking/NJ-140306-089" className="hover:text-amber-400 transition-colors">
                  پیگیری وضعیت سفارش
                </Link>
              </li>
              <li>
                <Link href="/cart" className="hover:text-amber-400 transition-colors">
                  سبد خرید و صدور پیش‌فاکتور
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-amber-400 transition-colors">
                  نحوه ارسال پیک در اصفهان
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-slate-800 p-3 rounded-xl border border-slate-700 text-center flex flex-col items-center justify-center">
                ...
                <span className="text-[9px] text-slate-400">الکتریک اصفهان</span>
              </div>
              <div className="bg-slate-800 p-3 rounded-xl border border-slate-700 text-center flex flex-col items-center justify-center">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href="https://t.me/naghshejahan_electric"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-3">
          <p>© تمامی حقوق برای فروشگاه کالای برق و الکترونیک نقش جهان (اصفهان) محفوظ است.</p>
          <p className="flex items-center gap-1">
            طراحی شده با Next.js و Tailwind برای صنف برق اصفهان
          </p>
        </div>
      </div>
    </footer>
